...
udev*            udev_new ();
void             udev_set_log_fn (udev* udev, void function(udev* udev, int priority, const(char)* file, int line, const(char)* fn, const(char)* format, va_list args) log_fn);
...
udev_device*     udev_device_get_parent_with_subsystem_devtype (udev_device* udev_device, const(char)* subsystem, const(char)* devtype);
